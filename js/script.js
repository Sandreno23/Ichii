...
hari.innerHTML = `${day()}, ${tgl} ${month()} ${year}`
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    imageUrl: "img/stiker_mylove.gif",
    imageHeight: 120,
    title: 'Halo, Kenalan Dong Cantik <3, Nama Kamu Siapa ?',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama Kamu , Aku Mau Kenalan :(`)
      }
      return { login }
    }
  }).then((result) => {
